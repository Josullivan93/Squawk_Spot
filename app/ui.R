    ...
    $(document).on('shiny:connected', function() {
      var checkPlotly = setInterval(function() {
        if (typeof Plotly !== 'undefined') {
          ...
          Shiny.setInputValue('plotly_initialized', true);
        }
      }, 100);
    });
  "))
                           ...
                           fluidRow(
                             column(width = 6,
                                    wellPanel(style = "background-color: #f9f9f9;",
                                              ...
                                              tags$audio(
                                                src = "https://raw.githubusercontent.com/Josullivan93/Squawk_Spot/fd04437c2857d0ab279c6c14cc862fdcd33edffd/www/demo/squawk_demo.wav",
                                                type = "audio/wav",
                                                controls = TRUE,
                             ...
                             column(width = 6,
                                    wellPanel(style = "background-color: #f9f9f9;",
                                              ...
                                              tags$audio(
                                                src = "https://raw.githubusercontent.com/Josullivan93/Squawk_Spot/fd04437c2857d0ab279c6c14cc862fdcd33edffd/www/demo/alarm_demo.wav",
                                                type = "audio/wav",
                                                controls = TRUE,
                                                style = "width: 100%; margin-bottom: 15px;"
                                              ),
